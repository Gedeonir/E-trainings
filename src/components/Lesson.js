...
const Lesson = () => {
  return (
    <div className='w-full grid grid-cols-4'>
        <div className='bg-secondary min-h-screen max-h-screen overflow-y-hidden'>
        ...
        <div className='col-span-3 overflow-y-auto max-h-screen min-h-screen px-12 py-4'>
            <h1 className='text-lg text-text_secondary'><span className='mx-2'>Lesson 2:</span>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</h1>
