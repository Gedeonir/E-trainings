                ...
                <div className='group relative'>
                    ...
                    <div id="dropdown" className="group-hover:block w-48 hidden z-40 absolute my-2 text-text_secondary bg-secondary divide-y  divide-gray-100 rounded-b-lg rounded-l-lg  shadow drop-shadow right-0 top-5">
                        <ul className="py-2 text-sm text-gray-900 dark:text-gray-300" aria-labelledby="dropdownDefaultButton">
                                ...
                                {props?.data?.memberProfile?.success?(
                                    <Link to="/my/profile" className='flex gap-4 justify-start'>
                                        ...
                                        <div className='text-text_secondary'>
                                            <label className='font-bold'>{props?.data?.memberProfile?.resp?.data?.getProfile?.fullNames}</label>
                                            <p className='text-[10px] font-bold'>View my profile</p>
                                        </div>
                                    </Link>
                                ):(
                                    <p></p>
                            ...
                            <li className="px-3 py-2 w-full text-left flex gap-4 justify-between hover:bg-text_secondary hover:bg-opacity-10">
                                Sign out
                            </li>
                        </ul>
                    </div>
