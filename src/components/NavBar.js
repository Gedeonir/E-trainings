...
const NavBar = () => {
  return (
    <header aria-label="Site Header" className="body-font sticky top-0 z-40 w-full py-4 lg:px-14 px-4 bg-secondary bg-opacity-90">
        <div className="flex justify-between">
            <div className="flex items-center w-1/5">
                <span>Logo</span>
            </div>

            <ul className="lg:flex justify-end w-3/5 hidden">
                <li className={`text-text_secondary  ${location.pathname==="/"&&'text-primary border-primary border-b-2'}   hover:border-b-2 cursor-pointer mx-4`}>
                    <Link to="/">
                        Home
                    </Link>
                </li>
                <li className={`text-text_secondary hover:hover:border-b-2 cursor-pointer mx-4 ${location.pathname==="/search"&&'text-primary border-primary border-b-2'}  `}>
                    <Link to="/search">
                        About us
                    </Link>
                </li>
                
                <li className="text-text_secondary hover:hover:border-b-2 cursor-pointer mx-4">
                    <Link >
                        Contact us
                    </Link>
                </li>
            ...
            <div className='flex justify-end gap-2 text-text_secondary lg:w-1/5'>
                ...
                <div>
                    <Link className='w-full border-2 border-primary rounded-lg text-primary text-center p-1 text-sm'>Join us for free</Link>
                </div>
